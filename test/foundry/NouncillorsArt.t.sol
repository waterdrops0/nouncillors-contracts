...
contract NouncillorsArtTest is Test, DescriptorHelpers {
    ...
    function setUp() public {
        ...
        art = new NouncillorsArt(descriptor, inflator);
    }
    ...
    function testSetDescriptorRevertsIfSenderNotDescriptor() public {
        vm.expectRevert(INouncillorsArt.SenderIsNotDescriptor.selector);
    ...
    function testPalettesRevertsGivenNoArt() public {
        vm.expectRevert(INouncillorsArt.PaletteNotFound.selector);
        art.palettes(0);
    }
    ...
    function testCannotSetEmptyPalette() public {
        vm.prank(descriptor);
        vm.expectRevert(INouncillorsArt.EmptyPalette.selector);
    ...
    function testCannotSetPaletteWithLengthNotAMultipleOf3() public {
        ...
        vm.expectRevert(INouncillorsArt.BadPaletteLength.selector);
    ...
    function testBodiesRevertsGivenNoArt() public {
        vm.expectRevert(INouncillorsArt.ImageNotFound.selector);
        art.bodies(0);
    }

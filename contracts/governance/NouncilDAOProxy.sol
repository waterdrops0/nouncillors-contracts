...
/// @title The Nouncil DAO proxy contract
...
// LICENSE
// NouncilDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// NouncilDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract NouncilDAOProxy is NouncilDAOProxyStorage, NouncilDAOEvents {
    constructor(
        address timelock_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'NouncilDAOProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'NouncilDAOProxy::_setImplementation: invalid implementation address');
